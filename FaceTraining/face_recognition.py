...
#Bg image
        img3 = Image.open(r"assets/img/bg_face_recog.png")
    ...
    def mark_attendance(self, i, r, n, d):
        with open("DiemDanh.csv", "r+", newline = "\n") as f:
            ...
            if ((i not in name_list) and (r not in name_list) and (n not in name_list) and (d not in name_list)):
                ...
                if ((dtString> '07:00:00' and dtString <'09:00:00') or (dtString> '09:15:00' and dtString <'11:15:00') or (dtString> '13:00:00' and dtString <'15:00:00') or (dtString> '15:15:00' and dtString <'17:15:00') or (dtString> '17:45:00' and dtString <'21:00:00')):
                    f.writelines(f"\n{i},{r},{n},{d},{dtString},{d1},Di tre")
                else:
                    f.writelines(f"\n{i},{r},{n},{d},{dtString},{d1},Vao lop")
